...
- **微信版本**: 仅支持微信 for Windows 3.9.12.x（内部版本号 19459 及以下）
- **调试目标**: 微信小程序需要 WMPFDebugger 代理

> **注意**: WMPFDebugger 对微信版本有严格要求。当前支持的微信版本号范围为 11581-19459（对应微信 for Windows 3.9.12.x 系列）。如果您的微信版本不在支持范围内，Frida hook 将无法正常工作。
